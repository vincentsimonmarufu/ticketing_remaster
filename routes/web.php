...
Route::group(['middleware' => ['web', 'checkblocked']], function () {
    ...
    Route::get('/issue', 'App\Http\Controllers\WelcomeController@issue')->name('issue');
    Route::get('/follow', 'App\Http\Controllers\WelcomeController@follow')->name('follow');
    Route::post('/follow', 'App\Http\Controllers\WelcomeController@followIssue')->name('tick.follow');
...
Route::post('/reports','App\Http\Controllers\ReportsController@getReports')->name('reports.selectreport');
...
Route::group(['middleware' => ['auth', 'activated', 'role:admin', 'activity', 'twostep', 'checkblocked']], function () {
    ...
    // tickets categories administration
    Route::resource('/categories', \App\Http\Controllers\TicketCategoryController::class);
    ...
    Route::get('/ticket/follow', 'App\Http\Controllers\TicketsController@followIssueForm');
